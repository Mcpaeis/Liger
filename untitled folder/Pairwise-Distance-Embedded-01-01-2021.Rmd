---
title: "Pairwise-Distance-Embedded-01-01-2021"
...
library(data.table)
# read in the data
pbmc_10X <- read.csv("/Users/sixtusdakurah/Desktop/Liger/data/H1-01-22-2021.csv")[, -1]
#pbmc_10X <- pbmc_10X[-dim(pbmc_10X)[1], ]
#pbmc_10X <- pbmc_10X[-1, ]
...
```{r}
pbmc_SqW <- read.csv("/Users/sixtusdakurah/Desktop/liger/data/H2-01-22-2021.csv")[, -1]
#pbmc_SqW <- pbmc_SqW[-dim(pbmc_SqW)[1], ]
...
library(tidyverse)
# merge the dataset
pbmc_10XSqWMergedTPL_Embedded <- rbind(pbmc_10X, pbmc_SqW)
write.csv(pbmc_10XSqWMergedTPL_Embedded, "/Users/sixtusdakurah/Desktop/liger/data/neumf_merged_embeddings.csv")
#write.table(pbmc_10XSqWMergedTPL_Embedded, file='/Users/sixtusdakurah/Desktop/liger/data/neumf_merged_embeddings.tsv', quote=FALSE, sep='\t', col.names = NA)
#head(pbmc_10XSqWMergedTPL_Embedded)
#tpl_df_embedded <- computeTripletLoss(pbmc_10XSqWMergedTPL_Embedded, original_clusters)
```

```{r}
head(tpl_df_embedded)
```
### TRIPLET LOSS COMPUTATIONS ENDS HERE

```{r}
#tpl_df_embedded[tpl_df_embedded$error==10000, ]
write.csv(tpl_df_embedded, "/Users/sixtusdakurah/Desktop/liger/data/tpl_embedded.csv")
```
...
ggplot(data = df_10XSQW_var_merged[-1, ]) + 
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + ggtitle("Non-Embedded-Variable Genes")
```
