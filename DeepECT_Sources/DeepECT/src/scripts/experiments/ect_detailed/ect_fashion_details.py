...
image_wh = 28
image_min_value = 0.0
augmentation_config = (-15,15), (0.08,0.08)
...
ae_model_path = Path(ae_dir, dataset_name,"ae_fashion-mnist_4.model")
...
for batch_data_id in test_loader:
    ...
    if all_embedded_data_np is None:
        ...
        all_embedded_data_np = np.concatenate([all_embedded_data_np, embeded_data.detach().cpu().numpy()],
                                              axis=0)
