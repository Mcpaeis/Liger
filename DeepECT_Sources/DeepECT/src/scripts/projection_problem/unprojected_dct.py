...
from ect.methods.ECT_unprojected import ECTreeUnprojected
from scripts.Config import *
from scripts.projection_problem.common_stuff import *


"""
This script shows the unprojected version of ECT and what deficiency this version has!
THIS IS NOT THE PROPOSED METHOD!
"""
...
ect_module = ECTreeUnprojected(optimizer, embedded_split_data_loader).cuda()
